        ...
        <header>
            <nav className='flex items-center justify-between py-5 font-medium'>
                <Link to='/' className='flex items-center gap-3'>
                    <img className='w-12' src={'/custom_logo.png'} onError={(e)=>{e.target.onerror=null; e.target.src=assets.logo}} alt='RentIt logo' />
                    <span className='text-xl font-semibold'>RentIt</span>
                </Link>
                        ...
                        {token && (
                            <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-3 drop-shadow-xl '>
                                <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-50 text-slate-700 rounded'>
                                    <p onClick={() => navigate('/new-listing')} className='cursor-pointer hover:text-black'>New Listing</p>
                                    <p onClick={() => navigate('/requests')} className='cursor-pointer hover:text-black'>Requests</p>
